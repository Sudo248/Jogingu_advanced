...
class StatisticFragment extends BaseFragment<StatisticBloc> {
  StatisticFragment({Key? key}) : super(key: key, name: AppRoutes.statistic) {
    // print("constructor statistic page");
  }
